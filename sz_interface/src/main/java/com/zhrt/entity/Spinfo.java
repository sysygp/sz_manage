...
public class Spinfo {
	...
	public void setF_linkid(String f_linkid) {
		this.f_linkid = f_linkid;
	}
	...
	public String getF_spnumber() {
		return f_spnumber;
	}
	public void setF_spnumber(String f_spnumber) {
		this.f_spnumber = f_spnumber;
	}
