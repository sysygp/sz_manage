...
<head>
	...
	<script type="text/javascript">
		function findByTime(){
			$("#mainForm").attr("action",$("#mainForm").attr("action")+"/mine?flag=1");
			$("#mainForm").submit();
		}
		function findByChan(){
			$("#mainForm").attr("action",$("#mainForm").attr("action")+"/mine?flag=2");
			$("#mainForm").submit();
		}
	</script>
</head>
...
<div class="well">
	...
	<span>
		<input type="button" value="按天查询" onclick="javascript:findByTime();">
    	<input type="button" value="汇总查询" onclick="javascript:findByChan();">			
	</span>
