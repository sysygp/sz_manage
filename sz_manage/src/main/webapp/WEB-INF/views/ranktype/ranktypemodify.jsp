...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/ranktype.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/ranktype">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label>排行版类型id</label>
		        <label>
		        	<input type="text" id="rankTypeId" name="rankTypeId" value="${entity.rankTypeId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="rankTypeId_tip" style="color:red"></lable>
		        </label>
		        
		        <label>排行版类型</label>
		        <label>
		        	<input type="text" id="rankTypeName" name="rankTypeName" value="${entity.rankTypeName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="rankTypeName_tip" style="color:red"></lable>
		        </label>
