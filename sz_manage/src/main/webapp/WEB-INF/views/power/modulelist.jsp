...
<div class="well">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td><input type="checkbox" name="ids" id="${entity.moduleId }" value="${entity.moduleId }"/></td>
          <td>${entity.moduleName }</td>
          <td>
              <a href="javascript:edit('e','${entity.moduleId }');">编辑</a>&nbsp;&nbsp;
              <a href="javascript:edit('v','${entity.moduleId }');">详情</a>&nbsp;&nbsp;
              <a href="javascript:del('${entity.moduleId }');" >删除</a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
