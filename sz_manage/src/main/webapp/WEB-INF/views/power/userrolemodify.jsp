...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/power/js/userrole.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/power/userrole">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		        ...
		        <label>角色</label>
		        <label>
		        	<input type="text" id="roleId" name="roleId" value="${entity.roleId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="roleId_tip" style="color:red"></lable>
		        </label>
		    </form>
	        </div>
		</div>
