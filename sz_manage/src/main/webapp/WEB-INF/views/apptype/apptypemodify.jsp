...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/apptype.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/apptype">
   ...
   <div style="color: red;text-align:center;">${errorInfo }</div>
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label><span style="color: red;">*</span>产品类型id</label>
		        <label>
		        	<input type="text" id="appTypeId" name="appTypeId" value="${entity.appTypeId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="appTypeId_tip" style="color:red"></lable>
		        </label>
		        
		        <label><span style="color: red;">*</span>产品类型</label>
		        <label>
		        	<input type="text" id="appTypeName" name="appTypeName" value="${entity.appTypeName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="appTypeName_tip" style="color:red"></lable>
		        </label>
