...
<div>
   ...
   <ul class="breadcrumb">
     ...
     <li class="active">${funMap[funcId]}</li>&nbsp;&nbsp;/&nbsp;&nbsp;子渠道管理&nbsp;
     <li style="float: right;"><a href="javascript:edit('a','0');" class="btn"> 新增 子渠道</a></li>
   </ul>
</div>
...
<input type="hidden" name="parentId" value="${channelInfo.parentId }">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          	  <c:if test="${entity.mainFlag eq 2 and entity.status ne 3 }"><a href="javascript:edit('e','${entity.id }');">编辑</a>&nbsp;&nbsp;</c:if>
              <a href="javascript:edit('v','${entity.id }');">详情</a>&nbsp;&nbsp;
              <c:if test="${entity.mainFlag eq 2 and entity.status ne 3 }"><a href="javascript:del('${entity.id }');" >删除</a></c:if>
              <a href="javascript:resetPassWord('${entity.id }');">重置密码</a>
          </td>
