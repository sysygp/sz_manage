...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/noticetype.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/noticetype">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label>通知类型id</label>
		        <label>
		        	<input type="text" id="noticeTypeId" name="noticeTypeId" value="${entity.noticeTypeId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="noticeTypeId_tip" style="color:red"></lable>
		        </label>
		        
		        <label>通知类型</label>
		        <label>
		        	<input type="text" id="noticeTypeName" name="noticeTypeName" value="${entity.noticeTypeName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="noticeTypeName_tip" style="color:red"></lable>
		        </label>
