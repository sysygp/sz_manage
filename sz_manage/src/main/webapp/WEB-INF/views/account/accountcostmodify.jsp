	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		        ...
		        <label>消费金额(元)</label>
		        <label>
		        	<input type="text" id="costMoney" name="costMoney" value="${entity.costMoney }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="costMoney_tip" style="color:red"></lable>
		        </label>
		        
		        <label>消费类型</label>
		        <label>
		        	<c:set var="payTypeMap" value="<%=Constant.payTypeMap %>"></c:set>
		        	<input type="text" id="costType" name="costType" value="${payTypeMap[fn:trim(entity.costType)].payType}" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="costType_tip" style="color:red"></lable>
		        </label>
