...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/plat.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/plat">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		        ...
		        <label>渠道ID</label>
		        <label>
		        	<input type="text" id="channelId" name="channelId" value="${entity.channelId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="platName_tip" style="color:red"></lable>
		        </label>
		        ...
		        <label>cpID</label>
		        <label>
		        	<input type="text" id="cpId" name="cpId" value="${entity.cpId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="platName_tip" style="color:red"></lable>
		        </label>
