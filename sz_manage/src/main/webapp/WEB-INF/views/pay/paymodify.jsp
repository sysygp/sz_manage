...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/pay.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/pay">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		        <label>支付类型</label>
		        <label>
		        	<input type="text" id="paytype" name="paytype" value="${entity.paytype }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="paytype_tip" style="color:red"></lable>
		        </label>
