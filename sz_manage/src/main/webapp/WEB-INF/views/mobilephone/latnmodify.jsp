...
<input type="hidden" name="id" id="id" value="${entity.latnId }" >
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label>省市名称</label>
		        <label>
		        	<input type="text" id="latnName" name="latnName" value="${entity.latnName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="latnName_tip" style="color:red"></lable>
		        </label>
		    
		    	<label>所属区域</label>
		        <label>
		        	<input type="text" id="latnAreacode" name="latnAreacode" value="${entity.latnAreacode }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="latnAreacode_tip" style="color:red"></lable>
		        </label>
		    </form>
	        </div>
