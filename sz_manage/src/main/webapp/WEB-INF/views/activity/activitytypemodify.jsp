...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/activitytype.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/activitytype">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label>活动类型id</label>
		        <label>
		        	<input type="text" id="activityTypeId" name="activityTypeId" value="${entity.activityTypeId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="activityTypeId_tip" style="color:red"></lable>
		        </label>
		        
		        <label>活动类型</label>
		        <label>
		        	<input type="text" id="activityTypeName" name="activityTypeName" value="${entity.activityTypeName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="activityTypeName_tip" style="color:red"></lable>
		        </label>
