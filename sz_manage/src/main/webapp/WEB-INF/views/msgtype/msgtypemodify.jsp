...
<head>
	...
	<script type="text/javascript" src="${ctx }/webresources/zhrt/js/msgtype.js" ></script>
	<script type="text/javascript" src="${ctx }/webresources/common/js/modify.js" ></script>
</head>

<body>
<form id="mainForm" method="post" action="/manager/zhrt/msgtype">
	...
	<div class="well">
	    ...
	    <div id="myTabContent" class="tab-content">
		    ...
		    <form id="tab">
		    	<label>消息类型id</label>
		        <label>
		        	<input type="text" id="msgTypeId" name="msgTypeId" value="${entity.msgTypeId }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="msgTypeId_tip" style="color:red"></lable>
		        </label>
		        
		        <label>消息类型</label>
		        <label>
		        	<input type="text" id="msgTypeName" name="msgTypeName" value="${entity.msgTypeName }" class="input-xlarge" style="height: 40px;">&nbsp;&nbsp;
		        	<lable id="msgTypeName_tip" style="color:red"></lable>
		        </label>
