...
public class ValiUtil {
	...
	public static boolean valiImei(String imei){
		boolean flag = true;
		if(StringUtils.isNotBlank(imei) && imei.length() != 15){
			flag = false; 
		}
		return flag;
	}
	 ...
	 * @return
	 */
	public static String valiValicode(String platId,String platidParam,String phone,String function){
	...
	public static String valiAccountPwd(String platId,String platidParam,String phone,String function,
			String accountPwdNew,String confirmPwdNew){
		String status = Constant.DEAL_OK+"";; 
